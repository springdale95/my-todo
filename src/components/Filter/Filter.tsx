...
const Filter = ({ filter, setFilter }: IFilter) => {
    return (
        <div>
            <FilterButtonAll filter={filter} setFilter={setFilter} />
            <FilterButtonActive filter={filter} setFilter={setFilter} />
            <FilterButtonDone filter={filter} setFilter={setFilter} />
        </div>
    );
};
